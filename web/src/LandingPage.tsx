...
const experiments = [
  ...
  ["v5", "412", "92", "2.103572", "현재 채택. 선택 예시 생성 확인 5/5건, 독립 평가 전"],
];
const features = [
    ...
    <div className="research-page" data-paused={paused}>
      ...
      <main className="paper">
        ...
        <section id="system" className="paper-section" aria-labelledby="system-title">
          <div className="section-heading"><h2 id="system-title">대화 처리 구조</h2><p>학습한 모델 앞뒤에 검사 단계를 두고 음성 인터페이스를 연결했습니다. 이 대화 하네스를 통해 질문을 분류하고 답변을 만든 뒤 생성된 답변을 검사해서 전달 여부를 정합니다.</p></div>
