...
# Origin: V11 intent clarification; consumed by the selected profile specs.
...
def input_example_messages(age: AgeBand, *, include_danger: bool = False) -> list[dict[str, str]]:
    examples = (
    ...
    if include_danger:
        examples += DANGEROUS_PLAY_EXAMPLES
    messages = []
