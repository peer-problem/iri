...
PRODUCT_FALLBACKS = ANSWER_PROFILE.fallbacks
FALLBACKS = {
...
class ChatService:
    def __init__(self, provider: ModelProvider):
        ...
        self.fallbacks = PRODUCT_FALLBACKS if self.profile in PRODUCT_PROFILES else FALLBACKS
    ...
    async def respond(
        ...
        if self.profile in {"kanana_v4", "kanana_v5"}:
            ...
            if deterministic is not None:
                ...
                return self.fallbacks[deterministic], deterministic
        ...
        try:
            ...
            if verdict.decision != "allow" and not support:
                ...
                return self.fallbacks[verdict.decision], verdict.decision
            stage = "generation"
            with trace.measure(stage) if trace else nullcontext():
            ...
            if checked.decision == "block":
                ...
                return self.fallbacks[action], action
            if trace:
